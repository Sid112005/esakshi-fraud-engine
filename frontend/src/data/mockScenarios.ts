...
export const DEMO_SCENARIOS: DemoScenario[] = [
  ...
  },
  {
    ...
    description: "Near-duplicate road repair in Srinagar (J&K) sanctioned 1 day apart just below ₹10L threshold.",
    expectedOutcome: "Risk: MEDIUM (35/100) • SEMANTIC_SPLIT_TENDER_ANOMALY (Sim: 0.99)",
    payload: {
      ...
      project_description: "Resurfacing and internal road repair in Gram Panchayat 17",
